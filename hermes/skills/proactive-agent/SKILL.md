...
description: "Transform AI agents from task-followers into proactive partners that anticipate needs and continuously improve. Part of the Hal Stack 🦞"
version: 3.1.0
author: halthelobster (ClawHub)
homepage: https://clawhub.ai/fangkelvin/find-skills-skill
license: MIT-0
metadata:
  hermes:
    tags: ["proactive", "automation", "self-improvement"]
---
...
> **Running on Hermes?** See `references/hermes-adaptation.md` for workspace mapping, onboarding workflow differences, and how to use Hermes' built-in memory/cron systems instead of OpenClaw's file-based approach.
