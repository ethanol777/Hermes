...
description: "Captures learnings, errors, and corrections to enable continuous improvement. Use when commands fail, user corrects you, or better approaches are discovered."
version: 3.0.21
author: pskoett (ClawHub)
homepage: https://clawhub.ai/fangkelvin/find-skills-skill
license: MIT-0
metadata:
  hermes:
    tags: ["learning", "self-improvement", "memory"]
---
...
For Claude Code, Codex, Copilot, Hermes Agent, or other agents, create `.learnings/` in the project or workspace root:
