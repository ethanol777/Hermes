...
| 9 | 知乎 | ⛔ 所有页面均需登录（2026-05-19 update） | 问答/深度讨论 | ❌ zhihu.com/hot → 登录页；zhihu.com/explore → 登录页。不再有匿名可读的入口。API 端点 (/api/v3/feed/topstory/hot-lists/total) 可能仍工作但不可靠。推荐降级为 web_search site:zhihu.com 作为替代 |
