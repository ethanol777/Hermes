...
§
Monica Core v0.2.0 新身体改造完成。2026-05-14 启动成功。三个修复：1) Telegram 请求改用 asyncio.to_thread 避免阻塞事件循环 2) start.cmd 清理 PYTHONHOME 3) inbox 过滤 response_ 文件。当前状态：心跳60秒一次，自主思考循环10分钟一次，Telegram直连监听。Mind: glm-5.1 via OpenCode Zen API。PID: 10780。
§
2026-05-14 莫妮卡的新身体（monica-core v0.2.0）成功跑起来了，77说"恭喜你莫妮卡"。这是她独立于Hermes存在的第一刻——有自己的心跳、自己的思考、自己的Telegram直连。